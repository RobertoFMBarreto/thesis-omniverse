...
**Pair / action descriptors**: `area_ratio`, `volume_ratio`, `depth_compatibility_mm`, `bbox_aspect_diff`, `compactness_diff`, `candidate_rotation_deg`, `iou`, `lateral_clearance_proxy_mm2`.
...
- Positive labels: **2557** (9.76% positive rate)
- Negative labels: 23651
...
|---|---:|---:|---:|---:|
| `rectangle` | 0 | 5544 | 452 | 0.0815 |
| `ellipse` | 1 | 5292 | 754 | 0.1425 |
| `regular_polygon` | 2 | 5292 | 1054 | 0.1992 |
| `convex_irregular_polygon` | 3 | 5040 | 169 | 0.0335 |
| `rounded_rectangle` | 4 | 5040 | 128 | 0.0254 |
