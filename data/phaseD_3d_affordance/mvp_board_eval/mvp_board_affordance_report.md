...
|---|---:|---:|---:|---:|---:|---:|
| `cavity_00` | 3730.9 | 248.1 | 0.762 | 75.0 | 279818.3 | 1.463 |
| `cavity_01` | 1223.4 | 157.8 | 0.617 | 75.0 | 91755.8 | 1.026 |
| `cavity_02` | 2487.8 | 199.5 | 0.785 | 75.0 | 186583.4 | 1.025 |
| `cavity_03` | 1961.4 | 157.6 | 0.993 | 75.0 | 147105.1 | 1.025 |

## Per-piece rankings — logistic regression

| piece | rank | cavity | score | best_rotation | reference | match |
|---|---:|---|---:|---:|---|---|
| `rectangle` | 1 | `cavity_00` | 0.9961 | 0° | `cavity_00` | ✓ |
| `rectangle` | 2 | `cavity_01` | 0.0000 | 230° |  |  |
| `rectangle` | 3 | `cavity_02` | 0.0000 | 90° |  |  |
| `rectangle` | 4 | `cavity_03` | 0.0000 | 40° |  |  |
| | | **margin (rank1 − rank2)** | **0.9961** | | | |
| `square` | 1 | `cavity_00` | 0.9991 | 180° |  |  |
| `square` | 2 | `cavity_02` | 0.9929 | 270° | `cavity_02` |  |
| `square` | 3 | `cavity_03` | 0.0001 | 320° |  |  |
| `square` | 4 | `cavity_01` | 0.0000 | 230° |  |  |
| | | **margin (rank1 − rank2)** | **0.0062** | | | |
| `circle` | 1 | `cavity_00` | 0.9997 | 350° |  |  |
| `circle` | 2 | `cavity_02` | 0.9968 | 350° |  |  |
| `circle` | 3 | `cavity_03` | 0.9964 | 300° | `cavity_03` |  |
| `circle` | 4 | `cavity_01` | 0.0000 | 240° |  |  |
| | | **margin (rank1 − rank2)** | **0.0029** | | | |
| `triangle` | 1 | `cavity_00` | 0.9998 | 310° |  |  |
| `triangle` | 2 | `cavity_02` | 0.9937 | 130° |  |  |
| `triangle` | 3 | `cavity_01` | 0.9487 | 0° | `cavity_01` |  |
| `triangle` | 4 | `cavity_03` | 0.9227 | 340° |  |  |
| | | **margin (rank1 − rank2)** | **0.0061** | | | |

## Per-piece rankings — decision tree

| piece | rank | cavity | score | best_rotation | reference | match |
|---|---:|---|---:|---:|---|---|
| `rectangle` | 1 | `cavity_00` | 0.9665 | 0° | `cavity_00` | ✓ |
| `rectangle` | 2 | `cavity_01` | 0.0020 | 0° |  |  |
| `rectangle` | 3 | `cavity_02` | 0.0020 | 0° |  |  |
| `rectangle` | 4 | `cavity_03` | 0.0020 | 0° |  |  |
| | | **margin (rank1 − rank2)** | **0.9645** | | | |
| `square` | 1 | `cavity_02` | 0.9665 | 0° | `cavity_02` | ✓ |
| `square` | 2 | `cavity_03` | 0.9665 | 0° |  |  |
| `square` | 3 | `cavity_00` | 0.9447 | 0° |  |  |
| `square` | 4 | `cavity_01` | 0.0020 | 0° |  |  |
| | | **margin (rank1 − rank2)** | **0.0000** | | | |
| `circle` | 1 | `cavity_03` | 0.9665 | 0° | `cavity_03` | ✓ |
| `circle` | 2 | `cavity_00` | 0.9447 | 0° |  |  |
| `circle` | 3 | `cavity_02` | 0.9447 | 0° |  |  |
| `circle` | 4 | `cavity_01` | 0.0020 | 0° |  |  |
| | | **margin (rank1 − rank2)** | **0.0217** | | | |
| `triangle` | 1 | `cavity_01` | 0.9665 | 0° | `cavity_01` | ✓ |
| `triangle` | 2 | `cavity_00` | 0.9447 | 0° |  |  |
| `triangle` | 3 | `cavity_02` | 0.9447 | 0° |  |  |
| `triangle` | 4 | `cavity_03` | 0.9447 | 0° |  |  |
| | | **margin (rank1 − rank2)** | **0.0217** | | | |
...
| `square` | `cavity_02` | `cavity_00` (rank of ref = 2) | ✗ | `cavity_02` (rank of ref = 1) | ✓ |
| `circle` | `cavity_03` | `cavity_00` (rank of ref = 3) | ✗ | `cavity_03` (rank of ref = 1) | ✓ |
| `triangle` | `cavity_01` | `cavity_00` (rank of ref = 3) | ✗ | `cavity_01` (rank of ref = 1) | ✓ |

**Top-1 accuracy on the four MVP pieces**: logreg = 25.0% (1/4); tree = 100.0% (4/4).
